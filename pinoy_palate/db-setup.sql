...
-- User Table (with separate name fields and status)
CREATE TABLE user (
    ...
    status ENUM('active', 'suspended') DEFAULT 'active',  -- New status field
...
-- Recipe-Ingredient Many-to-Many Table (Quantity with unit)
...
-- Insert Users (with display name and status)
INSERT INTO user (first_name, middle_name, last_name, display_name, email, password, role, status) VALUES
('Enrique', 'Anthony', 'Rodriguez', 'Rich', 'enriquearodriguez@students.abtech.edu', '$2y$10$nGoc0jcPXasM9Ms9awR.uOLTp7AOGvOgbUVMGbyBcysYkMVSut6ZC', 'admin', 'active'),
('Regular', 'B.', 'User', NULL, 'user@example.com', '$2y$10$CsiNaxVMTjGg/v8cucKo9uFPQ0auhvfFxBQGTXlzWfxcKwp/hRL/e', 'user', 'active');
